  ...
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      def ${func}():
          return ${a}
      ${func}()`,
      options: [func, Symbol(func), `${func}()`, 0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n]
    };
  }
}
  ...
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      def ${func}(${arg}):
          return ${arg}
      ${func}(${a})`,
      options: [arg, Symbol(arg), `${func}(${a})`, 0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n]
    };
  }
}
  ...
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      def ${func}(${arg}):
          return ${a}
      ${func}(${b})`,
      options: [arg, Symbol(arg), `${func}(${b})`, 0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n]
    };
  }
}
  ...
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      def ${func}():
          return ${a}
      ${func}() ${op} ${b}`,
      options: [0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n]
    };
  }
}
  ...
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      def ${func}(${arg}):
          return ${arg} ${op1} ${a}
      ${func}(${b}) ${op2} ${c}`,
      options: [0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n, correct+1n, correct-1n, correct+2n, correct-2n, correct+3n, correct-3n],
      opts: {correct},
    };
  }
}
...
export class FuncArgAndSaveResult extends EvalLastLineSubtopic {
  gen(): EvalLastLineQuestionGen {
    ...
    return { code: `
      ...
      ${x} = ${func}(${a})
      ${x}`,
      options: [x, Symbol(x), arg, Symbol(arg), `${func}(${a})`, 0n, 1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n]
    };
  }
}
